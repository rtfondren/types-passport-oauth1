...
declare class OAuth1Strategy extends Strategy {
    name: string;
    ...
    constructor(options: OAuth1Strategy.StrategyOptionsWithRequest, verify: OAuth1Strategy.VerifyFunctionWithRequest);

    authenticate(req: Request, options?: any): void;

    userProfile(token: string, tokenSecret: string, params: any, done: (err?: unknown, profile?: any) => void): void;
...
declare namespace OAuth1Strategy {
    ...
    type Strategy = OAuth1Strategy;
    const Strategy: typeof OAuth1Strategy;
}
